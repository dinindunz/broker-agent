...
echo ""
echo "🚀 Next Steps:"
echo "   • Deploy Broker Agent SDK runtime: ./06-deploy-sdk.sh"
...
echo ""
echo "🚀 Next Steps:"
echo "   1. Run ./06-deploy-sdk.sh to deploy Broker Agent SDK runtime"
echo "   2. Agents will use the gateway to access AWS tools"
